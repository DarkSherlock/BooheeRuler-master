...
public abstract class InnerRuler extends View {
    ...
    protected float mLineStartCoordinate;
    protected float mTextStartCoordinate;

    protected int mScaleTextMode;
    protected int mTextWidthSum;
...
//                Log.d("ruler", "computeScroll: " + mCurrentScale);
    ...
    protected abstract void drawEdgeEffect(Canvas canvas);
    ...
    public float getLineStartCoordinate() {
        return mLineStartCoordinate;
    }

    public float getTextStartCoordinate() {
        return mTextStartCoordinate;
    }

    public void setMode(@BooheeRuler.DisplayMode int scaleTextMode) {
        this.mScaleTextMode = scaleTextMode;
    ...
    public BooheeRuler getBooheeRuler() {
        return mParent;
    }
}

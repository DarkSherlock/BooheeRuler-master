...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        br_top_head.setDisplayMode(BooheeRuler.DisplayMode.MODE_SCALE_TEXT_BOTTOM);
        br_bottom_head.setDisplayMode(BooheeRuler.DisplayMode.MODE_SCALE_TEXT_BOTTOM);
//        br_left_head.setDisplayMode(BooheeRuler.DisplayMode.MODE_SCALE_TEXT_BOTTOM);
//        br_right_head.setDisplayMode(BooheeRuler.DisplayMode.MODE_SCALE_TEXT_BOTTOM);
    }
}
